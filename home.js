...
const canWeDeliverTwo = (zipCode) => {
    for (const code of deliveryAreaZipCodes) {
        if (code === zipCode) {
            console.log('You\'re in our delivery zone!');
            break;
        } else {
...
const newFirstDeal = deals[0].title.replace("15", "10");

console.log(newFirstDeal);
...
const newSecondDeal = deals[1].desc.replace("March", "April");
